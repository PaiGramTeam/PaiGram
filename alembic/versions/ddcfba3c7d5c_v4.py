...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "nickname", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "signature", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "sign_ibfk_1", "sign", "user", ["user_id"], ["user_id"]
    )
    op.create_table(
        "hoyoverse_cookies",
        ...
        sa.Column(
            "status",
            mysql.ENUM(
                "STATUS_SUCCESS", "INVALID_COOKIES", "TOO_MANY_REQUESTS"
            ),
            nullable=True,
        ),
        sa.Column("id", mysql.INTEGER(), autoincrement=True, nullable=False),
        sa.Column(
            "user_id", mysql.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.user_id"], name="hoyoverse_cookies_ibfk_1"
        ),
        sa.PrimaryKeyConstraint("id"),
        mysql_collate="utf8mb4_general_ci",
    ...
    op.create_table(
        "user",
        sa.Column(
            "region", mysql.ENUM("NULL", "HYPERION", "HOYOLAB"), nullable=True
        ),
        sa.Column("id", mysql.INTEGER(), autoincrement=True, nullable=False),
        sa.Column(
        ...
        sa.Column(
            "yuanshen_uid", mysql.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "genshin_uid", mysql.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.PrimaryKeyConstraint("id"),
        mysql_collate="utf8mb4_general_ci",
        mysql_default_charset="utf8mb4",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.user_id"], name="admin_ibfk_1"
        ),
        sa.PrimaryKeyConstraint("id"),
        mysql_collate="utf8mb4_general_ci",
        mysql_default_charset="utf8mb4",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.user_id"], name="mihoyo_cookies_ibfk_1"
        ),
        sa.PrimaryKeyConstraint("id"),
        mysql_collate="utf8mb4_general_ci",
        mysql_default_charset="utf8mb4",
