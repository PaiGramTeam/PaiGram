...
def upgrade() -> None:
    ...
    sa.Column('text', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.ForeignKeyConstraint(['question_id'], ['question.id'], onupdate='RESTRICT', ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id'),
    mysql_charset='utf8mb4',
    mysql_collate='utf8mb4_general_ci'
    )
    op.create_table('hoyoverse_cookies',
    ...
    op.create_table('mihoyo_cookies',
    sa.Column('cookies', sa.JSON(), nullable=True),
    sa.Column('status', sa.Enum('STATUS_SUCCESS', 'INVALID_COOKIES', 'TOO_MANY_REQUESTS', name='cookiesstatusenum'), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    ...
    sa.Column('status', sa.Enum('STATUS_SUCCESS', 'INVALID_COOKIES', 'ALREADY_CLAIMED', 'GENSHIN_EXCEPTION', 'TIMEOUT_ERROR', 'BAD_REQUEST', 'FORBIDDEN', name='signstatusenum'), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
